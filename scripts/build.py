...
<style>
:root{{--paper:#faf7f3;--paper:#faf7f3;--paper:oklch(0.978 0.006 80);--ink:#080401;--ink:#080401;--ink:oklch(0.11 0.015 60);--accent:#5f000b;--accent:#5f000b;--accent:oklch(0.30 0.13 22);--dim:#6d6863;--dim:#6d6863;--dim:oklch(0.52 0.01 70);--rule:#d6d4d1;--rule:#d6d4d1;--rule:oklch(0.87 0.005 80)}}
...
code{{background:#edebe7;background:#edebe7;background:oklch(0.94 0.005 80);padding:1px 5px;border-radius:4px;font-size:13px}}
